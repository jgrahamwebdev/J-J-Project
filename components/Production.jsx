...
function Production() {
  ...
  <div className='parallax w-screen h-auto bg-fixed bg-cover'>
    <div className='h-[32rem] w-screen flex items-center justify-center flex-col'>
        <div className=''>
            <h1 className='text-white text-[2.5rem]'>LOREM IPSUM DOLOR</h1>
        </div>
        <div className="w-screen h-[5rem] flex items-center justify-center">
          <button className="w-52 h-11 text-white border text-[12px] border-white font-light">WORK WITH US &rarr;</button>
        </div>
    </div>
    <Instagram />
  </div>
