  ...
  return (
      <div className='w-screen h-screen bg-white flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='w-full h-3/4 flex items-center justify-center flex-col bg-slate-200'>  
          <h1 className='text-[2rem] mb-4'>SHIPPING:</h1>        
            
            <Link href='/order'><button className="bg-slate-500 text-white flex items-center justify-around self-end w-[8rem] h-[2rem] mx-6">ORDER <ArrowNarrowRightIcon className='w-4 h-4'/></button></Link>
        </div>
      </div>
  )
}
